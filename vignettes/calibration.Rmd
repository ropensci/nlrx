...
The nlrx package provides different algorithms from the [EasyABC package](https://cran.r-project.org/web/packages/EasyABC/index.html).
These algorithms can be used by attaching the corresponding simdesigns (`simdesign_ABCmcmc_Marjoram()`, `simdesign_ABCmcmc_MarjoramO()`, `simdesign_ABCmcmc_Wegmann()`). 
...
However, other ABC simdesigns work in a very similar way except for the parameter definitions within the simdesigns (see respective documentation pages for help).
