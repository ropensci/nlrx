...
nlrx provides a bunch of different simdesigns that generate parameter input matrices from valid experiment variable definitions.
These simdesigns represent different techniques of parameter space exploration.
...
Details on the sensitivity analysis methods can be found in the documentation of the [sensitivity package](https://cran.r-project.org/web/packages/sensitivity/index.html).
Details on the optimization methods can be found in the documentation of the [genalg package](https://cran.r-project.org/web/packages/genalg/index.html) and the [GenSA package](https://cran.r-project.org/web/packages/GenSA/index.html).
