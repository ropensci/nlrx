...
nl <- nl(nlversion = "7.0.4",
         nlpath = netlogopath,
         modelpath = file.path(netlogopath, "models/Sample Models/Art/Diffusion Graphics.nlogox"),
         jvmmem = 1024)
...
nl <- nl(nlversion = "7.0.4",
         nlpath = netlogopath,
         modelpath = file.path(netlogopath, "models/Sample Models/Earth Science/Fire.nlogox"),
         jvmmem = 1024)
...
nl <- nl(nlversion = "7.0.4",
         nlpath = netlogopath,
         modelpath = file.path(netlogopath, "models/Sample Models/Biology/Ants.nlogox"),
         jvmmem = 1024)
...
## Windows:
modelpath <- "models/Sample Models/Chemistry ^& Physics/Waves/Wave Machine.nlogox"
## Linux:
modelpath <- "models/Sample Models/Chemistry & Physics/Waves/Wave Machine.nlogox"
...
nl <- nl(nlversion = "7.0.4",
         nlpath = netlogopath,
         modelpath = file.path(netlogopath, "models/Sample Models/Biology/Flocking.nlogox"),
         jvmmem = 1024)
...
nl <- nl(nlversion = "7.0.4",
         nlpath = netlogopath,
         modelpath = file.path(netlogopath, "models/Sample Models/Networks/Preferential Attachment.nlogox"),
         jvmmem = 1024)
