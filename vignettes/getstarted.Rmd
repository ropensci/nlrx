...
Simulations are organised into blocks that can be executed in parallel via NetLogo's native multithreading (`threads`) and, for large designs, distributed across remote HPC machines (see "Advanced configuration" vignette for more information on parallelisation).
