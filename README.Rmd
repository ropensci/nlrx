...
Details on the specific slots of the experiment class can be found in the package documentation (`?experiment`) and the "Further Notes" vignette.
...
The loops are constructed in a way that allows easy parallelisation, either locally or on remote HPC machines (see "Further Notes" vignette for more information on parallelisation).
