...
#' Both approaches try to minimize a specified model output reporter by systematically (genetic algorithm, utilizing the [genalg](https://CRAN.R-project.org/package=genalg/index.html/) package) or randomly (simulated annealing, utilizing the [genSA](https://cran.r-project.org/web/packages/GenSA/index.html) package) changing the model parameters within the allowed ranges.
